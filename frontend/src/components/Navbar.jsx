...
const Navbar = () => { 
    ...
    <div className="flex items-center justify-between py-5 font-medium">  
        <NavLink to='/'><img src={assets.Fashionista} className="w-[90px]"/> </NavLink>
        ...
        <div className="flex items-center gap-6"> 
            <img onClick={()=>{
                setshowSearch(true)
            }}src={assets.search_icon} className="cursor-pointer w-5"/> 

            <div className="group relative"> 
                
                <img onClick={()=>{token ? null : navigate("/login")}} src={assets.profile_icon} className="cursor-pointer w-5"></img>  
